...
<form  method="get" action="<?php echo e(route('planningProfSemaineRespo')); ?>">
	<div>
...
<table border="2">
	...
	<tr>
		...
		<div id=content>
        	<div class="block-center">
				<?php $__currentLoopData = $planningEnsei; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planningEnsei): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						<td><?php echo e($planningEnsei -> id); ?></td> 
						<td><?php echo e($planningEnsei -> cours_id); ?></td> 
						<td><?php echo e($planningEnsei -> intitule); ?></td>
						<td><?php echo e($planningEnsei -> date_debut); ?></td>
						<td><?php echo e($planningEnsei -> date_fin); ?></td>
						<td><a href="<?php echo e(route('misAjourForm', ['id_planning'=>$planningEnsei->id])); ?>">METTRE À JOUR VOTRE SÉANCE</a></td>
						<td><a href="<?php echo e(route('suppressionSeance', ['id_planning'=>$planningEnsei->id])); ?>">SUPPRIMER</a></td>		
						<td><a href="<?php echo e(route('planningProfCours', ['id_cours'=>$planningEnsei->cours_id])); ?>">Afficher</a></td>
					</tr>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</div>
		</div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/haphuong/Documents/WEB/L2DOUBLE/projet/projetWeb/resources/views/Prof/listePlanningIntegralRespo.blade.php ENDPATH**/ ?>